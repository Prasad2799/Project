...
<body>
    ...
    <button class="btn"><i class=""></i> <a href="video.html">विडियो</a></button>
    ...
    <div class="container py-md-5 py-4">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 item">
                <a href="assets/images/social/mns1.jpg" data-lightbox="example-set" data-title="img 1"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns1.jpg" alt="Card image cap">
            ...
            <div class="col-lg-4 col-md-6 item mt-md-0 mt-4">
                <a href="assets/images/social/mns2.jpg" data-lightbox="example-set" data-title="img 2"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns2.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title"> </span>
                        <span class="content">       </span>
            ...
            <div class="col-lg-4 col-md-6 item mt-lg-0 mt-4">
                <a href="assets/images/social/mns4.jpg" data-lightbox="example-set" data-title="img 3"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns4.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">            </span>
                        <span class="content"></span>
           ...
           <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns5.jpg" data-lightbox="example-set" data-title="img 4"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns5.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">    </span>
                        <span class="content"></span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns6.jpg" data-lightbox="example-set" data-title="img 5"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns6.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">  </span>
                        <span class="content"></span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns7.jpg" data-lightbox="example-set" data-title="img 6"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns7.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">   </span>
                        <span class="content"> </span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns8.jpg" data-lightbox="example-set" data-title="img 4"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns8.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">    </span>
                        <span class="content"> </span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns9.jpg" data-lightbox="example-set" data-title="img 5"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns9.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">  </span>
                        <span class="content">     </span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns10.jpg" data-lightbox="example-set" data-title="img 6"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns10.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title"> </span>
                        <span class="content"> </span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns11.jpg" data-lightbox="example-set" data-title="img 4"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns11.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">    </span>
                        <span class="content"></span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns12.jpg" data-lightbox="example-set" data-title="img 5"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns12.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">  </span>
                        <span class="content"></span>
            ...
            <div class="col-lg-4 col-md-6 item mt-4 pt-lg-2">
                <a href="assets/images/social/mns13.jpg" data-lightbox="example-set" data-title="img 6"
                    class="zoom d-block">
                    <img class="card-img-bottom d-block" src="assets/images/social/mns13.jpg" alt="Card image cap">
                    <span class="overlay__hover"></span>
                    <span class="hover-content">
                        <span class="title">   </span>
                        <span class="content"> </span>
       ...
       <!-- <div class="text-center mt-5">
            <a href="services.html" class="btn btn-style"> More</a>
        </div>-->
    </div>
</section>
<!-- //projects section -->
