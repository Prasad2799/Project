...
<body style="background-color:rgb(255, 200, 118);">
    ...
    <div class="page-title-area title-img-one">
        <div class="title-shape">
            <img data-cfsrc="assets/images/page-title/title-shape.jpg" alt="Title" style="display:none;visibility:hidden;"><noscript><img src="assets/images/page-title/title-shape.jpg" alt="Title"></noscript>
            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="title-content">
                        <h2>स्वयंसेवक व्हा</h2>
                        <ul>
                            <li>
                                <a href="index.html">मुख्यपृष्ठ</a>
                            </li>
                            <li>
                                <span>स्वयंसेवक व्हा</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="help-page-area two ptb-100">
        <div class="container">
            <div class="section-title">
                <h2>स्वयंसेवक व्हा</h2>
            </div>
            <div class="help-content">
                <form class "m-t-30 "action="volunteer_backend.php" method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>पत्ता ओळ १:</label>
                                <input type="text" name="address1" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>पत्ता ओळ २ :</label>
                                <input type="text" name="address2" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>स्वतःबद्दल थोडे वर्णन करा</label>
                                <textarea id="your-message" name="message" rows="8" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                     <div class="text-center">
                        <button type="submit" class="btn common-btn"><a href="volunteer_backend.php">
 
   </a>आमच्यासोबत सामील व्हा</button>
                    </div>
                </form>
            </div>
        </div>
